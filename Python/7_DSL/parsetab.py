...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','dsl.py',68),
  ('statement -> expression','statement',1,'p_statement_expr','dsl.py',73),
  ('expression -> expression + expression','expression',3,'p_expression_binop','dsl.py',78),
  ('expression -> expression - expression','expression',3,'p_expression_binop','dsl.py',79),
  ('expression -> expression * expression','expression',3,'p_expression_binop','dsl.py',80),
  ('expression -> expression / expression','expression',3,'p_expression_binop','dsl.py',81),
  ('expression -> - expression','expression',2,'p_expression_uminus','dsl.py',93),
  ('expression -> ( expression )','expression',3,'p_expression_group','dsl.py',98),
  ('expression -> NUMBER','expression',1,'p_expression_number','dsl.py',103),
  ('expression -> NAME','expression',1,'p_expression_name','dsl.py',108),
]
